...
const CreateFood = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      await api.post(API_ENDPOINTS.FOOD.BASE, formData, {
  ...
  const isDisabled = useMemo(
    () => !name.trim() || !videoFile || loading || (isOrderable && !price),
    [name, videoFile, loading, isOrderable, price]
  );
  ...
  return (
    <main className="profile-page">
      ...
      <form onSubmit={onSubmit} className="create-food-form-container">
        <label htmlFor="foodVideo" className="form-field-label">
          Food Video
        </label>
          ...
          >
            ...
            {videoFile ? (
              ...
              <>
                ...
                <span className="video-upload-secondary-text">
                  or drag and drop
                </span>
                <span className="video-upload-hint-text">
        ...
        <label htmlFor="foodName" className="form-field-label">
          Name
        </label>
        ...
        <label htmlFor="foodDesc" className="form-field-label">
          Description
        </label>
        <div className="form-input-card">
          <textarea
        ...
        {isOrderable && (
          <div className="form-input-card">
            <label htmlFor="price" className="form-field-label">
              Price ($)
            </label>
            <input
              id="price"
